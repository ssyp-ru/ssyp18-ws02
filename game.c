...
void main_cycle(avect_t * actors, avect_t ** queue, size_t qlen, level_vector_t* levels)
{
	bool exit = false;
...
void destroy_the_world(avect_t* actors, level_vector_t * levels, avect_t ** queue, int qlen)
{
	lvector_free(levels);
